...
public class StatusBar {
    ...
    public StatusBar(Group root, int sceneWidth, int sceneHeight, Game game) {
        ...
        HBox live = statusGroup(ImageResource.HEART.getImage(), lives);
    ...
    public void update(Game game) {
        ...
        String playerLives = toString(player.getLives());
        String bombBagCapacity = toString(player.getBombs());
        String key = toString(player.getKeys());
        String bombsRange = toString(player.getBombRange());
        updateLevel(player.getLevels());
        lives.setText(playerLives);
        bombRange.setText(bombsRange);
        availableBombs.setText(bombBagCapacity);
        keys.setText(key);
    }
